...
HD_PWD='C:/Users/fmabrouk/Documents/GitHub/DDS_FM_Transmitter_100Hz/FM_Modulation/FM_Modulation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FM_ModulatorTopLevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FM_ModulatorTopLevel.tcl
